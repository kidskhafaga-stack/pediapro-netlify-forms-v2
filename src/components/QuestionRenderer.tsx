  ...
  const renderTitle = () => (
    <div className="mb-3">
      <div className="flex items-start gap-2">
        ...
        {question.infoText && (
          <button
            ...
            className={`shrink-0 mt-0.5 transition-colors focus:outline-none ${showInfo ? 'text-[#1477af]' : 'text-slate-400 hover:text-[#1477af]'}`}
          >
      ...
      {showInfo && question.infoText && (
        <div className="mt-2.5 p-3.5 bg-[#1477af]/[0.06] border border-[#1477af]/15 rounded-xl text-[13.5px] text-slate-600 leading-relaxed animate-in fade-in slide-in-from-top-1 duration-200">
          {question.infoText}
        </div>
      )}
    </div>
